...
RCT_EXPORT_METHOD(setupAPIKey:(NSString *)key resolver:(RCTPromiseResolveBlock)resolve
...
RCT_EXPORT_METHOD(presentLoginFromViewController:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
...
RCT_EXPORT_METHOD(loginToSumUpWithToken:(NSString *)token resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
...
RCT_EXPORT_METHOD(paymentCheckout:(NSDictionary *)request resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
    ...
    NSString *foreignTransactionID = [RCTConvert NSString:[request objectForKeyNotNull:@"foreignID"]];
